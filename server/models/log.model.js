...
class LogModel {
    ...
    SELECT_USERLOG(userId) {
        return new Promise((resolve, reject) => {
            const query = "SELECT l.id, l.action, u.name, l.subject, l.from_column, l.to_column, l.createdAt FROM Log l INNER JOIN Users u ON l.user_id = u.id WHERE l.user_id in (?) ORDER BY l.createdAt DESC";
